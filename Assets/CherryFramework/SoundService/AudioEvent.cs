...
namespace CherryFramework.SoundService
{
    ...
    public class AudioEvent
    {
        ...
        [Group("clip")][Range(0f,1f)][DrawWithUnity][SerializeField] public float volume = 1f;
        [Group("clip")][Range(0f,3f)] public float pitch = 1f;
        [Group("clip")][Range(-1f,1f)] public float panStereo;
        [Group("clip")][Range(0f,1f)] public float spatialBlend;
        [Group("clip")][Range(0f,1.1f)] public float reverbZoneMix = 1f;
        [Group("clip")][Range(0f,5f)] public float dopplerLevel = 1f;
        [Group("clip")][Range(0f,360f)] public float spread;
        ...
        private TriValidationResult EventNameCorrect() => eventKey.IsNullOrWhiteSpace() ? TriValidationResult.Error("Event name must be NOT empty") : TriValidationResult.Valid;
    }
}